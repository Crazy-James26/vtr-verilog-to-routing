...
`timescale 1ns/1ps
module huffman_enc_truncated_length_histogram1_V_RAM_AUTO_1R1W
#(parameter
    DataWidth    = 10,
    AddressRange = 64,
    AddressWidth = 6,
...
generate
    for (i = 0; i < BufferCount; i = i + 1) begin : gen_buffer
        huffman_enc_truncated_length_histogram1_V_RAM_AUTO_1R1W_memcore huffman_enc_truncated_length_histogram1_V_RAM_AUTO_1R1W_memcore_U (
            .ce0      ( buf_ce0[i] ),
            .we0      ( buf_we0[i] ),
            .address0 ( buf_a0[i] ),
            .d0       ( buf_d0[i] ),

...
module huffman_enc_Block_entry917_proc (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg    ap_block_state1;
wire   [31:0] zext_ln309_fu_12_p1;
wire   [8:0] trunc_ln309_fu_16_p1;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((~((ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
                        ap_return_1_preg[9 : 0] <= zext_ln309_fu_12_p1[9 : 0];
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((~((ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
            ap_return_2_preg <= trunc_ln309_fu_16_p1;
        end
    end
end
...
always @ (*) begin
    if ((~((ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        ap_return_1 = zext_ln309_fu_12_p1;
    end else begin
...
always @ (*) begin
    if ((~((ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        ap_return_2 = trunc_ln309_fu_16_p1;
    end else begin
...
assign trunc_ln309_fu_16_p1 = p_read[8:0];

assign zext_ln309_fu_12_p1 = p_read;

always @ (posedge ap_clk) begin
    ap_return_1_preg[31:10] <= 22'b0000000000000000000000;
end

endmodule //huffman_enc_Block_entry917_proc

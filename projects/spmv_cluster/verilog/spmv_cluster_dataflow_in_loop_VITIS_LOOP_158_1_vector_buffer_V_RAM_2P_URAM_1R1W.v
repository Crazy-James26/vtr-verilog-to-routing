...
`timescale 1ns/1ps
module spmv_cluster_dataflow_in_loop_VITIS_LOOP_158_1_vector_buffer_V_RAM_2P_URAM_1R1W
#(parameter
    DataWidth    = 32,
    AddressRange = 4096,
    AddressWidth = 12,
...
generate
    for (i = 0; i < BufferCount; i = i + 1) begin : gen_buffer
        spmv_cluster_dataflow_in_loop_VITIS_LOOP_158_1_vector_buffer_V_RAM_2P_URAM_1R1W_memcore spmv_cluster_dataflow_in_loop_VITIS_LOOP_158_1_vector_buffer_V_RAM_2P_URAM_1R1W_memcore_U (
            .ce0      ( buf_ce0[i] ),
            .address0 ( buf_a0[i] ),
            .q0       ( buf_q0[i] ),
            .ce1      ( buf_ce1[i] ),
